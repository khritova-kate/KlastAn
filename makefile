a.out:  My_Point2d.o My_Group2D.o My_Cluster.o My_Poisk.o My_Field.o My_Controller.o My_Interface.o main.o
	g++ My_Point2d.o My_Group2D.o My_Cluster.o My_Poisk.o My_Field.o My_Controller.o My_Interface.o main.o
...
My_Poisk.o: My_Poisk.cpp My_Poisk.h
	g++ -c My_Poisk.cpp
